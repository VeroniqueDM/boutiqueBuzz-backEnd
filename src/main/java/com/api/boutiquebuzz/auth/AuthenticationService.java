...
import com.api.boutiquebuzz.config.JwtService;
import com.api.boutiquebuzz.token.Token;
import com.api.boutiquebuzz.token.TokenRepository;
import com.api.boutiquebuzz.token.TokenType;
import com.api.boutiquebuzz.user.Role;
...
//    System.out.println("SecConHolder: "+ SecurityContextHolder.getContext());
    System.out.println("Auth: "+ authentication);
    SecurityContextHolder.clearContext();
    SecurityContextHolder.getContext().setAuthentication(authentication);

    System.out.println("SecConHolder (2): "+ SecurityContextHolder.getContext());
